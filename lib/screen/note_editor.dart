...
class _NoteEditorState extends State<NoteEditor> with CommandHandler {
  ...
  Widget _buildBody(BuildContext context, String uid) => DefaultTextStyle(
        ...
        child: WillPopScope(
          // Try set state line on this point
        ...
        children: <Widget>[
          TextField(
            ...
            decoration: InputDecoration(
              hintText: tit.i18n, hintStyle: TextStyle(color: Colors.black),
          ...
          TextField(
            ...
            style: kNoteTextLargeLight,
            decoration: InputDecoration.collapsed(hintText: content.i18n , hintStyle: TextStyle(color: Colors.black)),
            maxLines: null,
            textCapitalization: TextCapitalization.sentences,
            readOnly: !_note.state.canEdit,
          ),
  ...
  List<Widget> _buildTopActions(BuildContext context, String uid) => [
        ...
        IconButton(
            icon: Icon(Icons.save_outlined, color: kInactive),
            tooltip: 'Save',
            onPressed: () {
              _onPop(uid);
  ...
  //TODO: here do the function when keyboard appears
  ...
  Widget _buildBottomAppBar(BuildContext context) => BottomAppBar(
        child: Container(
          ...
          child: Row(
            ...
            children: <Widget>[
//TODO plus box on bottom of note editor
              IconButton(
  ...
  //this is not meant to be here i added this to check wether this will work or not and this does not work
  //Look into it  some time after wards. set state function
